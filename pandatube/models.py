...
class CourseTag(models.Model):
    ...
    course_thumbnail = models.FileField(upload_to= course_thumbnail_path, default='https://pandabase.sgp1.cdn.digitaloceanspaces.com/pandabase/default/default/default-video.jpg')
    def __str__(self):
